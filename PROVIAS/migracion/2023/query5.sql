...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico_2023 WITH (TABLOCK)
    SELECT * FROM #tmp;
...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoOrigen_Historico_2023 WITH (TABLOCK)
    SELECT * FROM #tmp2;
