...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoOrigenDestino_Historico_2024 WITH (TABLOCK)
    SELECT * FROM #tmp;
...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico_2024 WITH (TABLOCK)
    SELECT * FROM #tmp2;
