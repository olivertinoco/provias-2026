...
BEGIN
    ...
    WHERE doc.FechaCreacionAuditoria >= '20240101' AND doc.FechaCreacionAuditoria <  '20250101'
...
BEGIN
    ...
    WHERE FechaCreacionAuditoria >= '20240101' AND FechaCreacionAuditoria <  '20250101'
