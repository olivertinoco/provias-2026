...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoOrigenDestino_Historico WITH (TABLOCK)
    SELECT * FROM #tmp;
...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico WITH (TABLOCK)
    SELECT * FROM #tmp2;
