GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.Expediente_Historico_2025','U'))
drop table Tramite.Expediente_Historico_2025
GO
create table Tramite.Expediente_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDevuelto_Historico_2025','U'))
drop table Tramite.ExpedienteDevuelto_Historico_2025
GO
create table Tramite.ExpedienteDevuelto_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumento_Historico_2025','U'))
drop table Tramite.ExpedienteDocumento_Historico_2025
GO
create table Tramite.ExpedienteDocumento_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoAdjunto_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoAdjunto_Historico_2025
GO
create table Tramite.ExpedienteDocumentoAdjunto_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoAdjuntoFirmante_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoAdjuntoFirmante_Historico_2025
GO
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico_2025
GO
create table Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoFirmante_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoFirmante_Historico_2025
GO
create table Tramite.ExpedienteDocumentoFirmante_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigen_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoOrigen_Historico_2025
GO
create table Tramite.ExpedienteDocumentoOrigen_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigenAdjunto_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoOrigenAdjunto_Historico_2025
GO
create table Tramite.ExpedienteDocumentoOrigenAdjunto_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigenDestino_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoOrigenDestino_Historico_2025
GO
create table Tramite.ExpedienteDocumentoOrigenDestino_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico_2025
GO
create table Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico_2025
GO
create table Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoVisualizacion_Historico_2025','U'))
drop table Tramite.ExpedienteDocumentoVisualizacion_Historico_2025
GO
create table Tramite.ExpedienteDocumentoVisualizacion_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteEnlazado_Historico_2025','U'))
drop table Tramite.ExpedienteEnlazado_Historico_2025
GO
create table Tramite.ExpedienteEnlazado_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteSeguimiento_Historico_2025','U'))
drop table Tramite.ExpedienteSeguimiento_Historico_2025
GO
create table Tramite.ExpedienteSeguimiento_Historico_2025 (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.NumeracionSeparada_Historico_2025','U'))
drop table Tramite.NumeracionSeparada_Historico_2025
GO
create table Tramite.NumeracionSeparada_Historico_2025 (
