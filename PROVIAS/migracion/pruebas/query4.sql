...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico WITH (TABLOCK)
    SELECT * FROM #tmp;
...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumento_Historico WITH (TABLOCK)
    SELECT * FROM #tmp2;
...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoFirmante_Historico WITH (TABLOCK)
    SELECT * FROM #tmp3;
