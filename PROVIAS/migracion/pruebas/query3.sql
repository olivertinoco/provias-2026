...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoOrigenAdjunto_Historico WITH (TABLOCK)
    SELECT * FROM #tmp;
...
BEGIN
    ...
    INSERT INTO Tramite.Expediente_Historico WITH (TABLOCK)
    SELECT * FROM #tmp2;
...
BEGIN
    ...
    INSERT INTO Tramite.ExpedienteDocumentoAdjunto_Historico WITH (TABLOCK)
    SELECT * FROM #tmp3;
