GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.Expediente_Historico','U'))
drop table Tramite.Expediente_Historico
GO
create table Tramite.Expediente_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDevuelto_Historico','U'))
drop table Tramite.ExpedienteDevuelto_Historico
GO
create table Tramite.ExpedienteDevuelto_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumento_Historico','U'))
drop table Tramite.ExpedienteDocumento_Historico
GO
create table Tramite.ExpedienteDocumento_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoAdjunto_Historico','U'))
drop table Tramite.ExpedienteDocumentoAdjunto_Historico
GO
create table Tramite.ExpedienteDocumentoAdjunto_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoAdjuntoFirmante_Historico','U'))
drop table Tramite.ExpedienteDocumentoAdjuntoFirmante_Historico
GO
create table Tramite.ExpedienteDocumentoAdjuntoFirmante_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico','U'))
drop table Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico
GO
create table Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoFirmante_Historico','U'))
drop table Tramite.ExpedienteDocumentoFirmante_Historico
GO
create table Tramite.ExpedienteDocumentoFirmante_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigen_Historico','U'))
drop table Tramite.ExpedienteDocumentoOrigen_Historico
GO
create table Tramite.ExpedienteDocumentoOrigen_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigenAdjunto_Historico','U'))
drop table Tramite.ExpedienteDocumentoOrigenAdjunto_Historico
GO
create table Tramite.ExpedienteDocumentoOrigenAdjunto_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigenDestino_Historico','U'))
drop table Tramite.ExpedienteDocumentoOrigenDestino_Historico
GO
create table Tramite.ExpedienteDocumentoOrigenDestino_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico','U'))
drop table Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico
GO
create table Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico','U'))
drop table Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico
GO
create table Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteDocumentoVisualizacion_Historico','U'))
drop table Tramite.ExpedienteDocumentoVisualizacion_Historico
GO
create table Tramite.ExpedienteDocumentoVisualizacion_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteEnlazado_Historico','U'))
drop table Tramite.ExpedienteEnlazado_Historico
GO
create table Tramite.ExpedienteEnlazado_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.ExpedienteSeguimiento_Historico','U'))
drop table Tramite.ExpedienteSeguimiento_Historico
GO
create table Tramite.ExpedienteSeguimiento_Historico (
...
GO
if exists(select 1 from sys.sysobjects where id=object_id('Tramite.NumeracionSeparada_Historico','U'))
drop table Tramite.NumeracionSeparada_Historico
GO
create table Tramite.NumeracionSeparada_Historico (
