...
-- cross apply Tramite.NumeracionSeparada_Historico_2022 tt
-- where tt.IdNumeracionSeparada = t.IdNumeracionSeparada


-- delete t from Tramite.ExpedienteDocumentoOrigenDestinoTemporal t
-- cross apply Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico_2022 tt
...
-- cross apply Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico_2022 tt
...
-- cross apply Tramite.ExpedienteDocumentoOrigenAdjunto_Historico_2022 tt
...
-- cross apply Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico_2022 tt
...
-- cross apply Tramite.ExpedienteDocumentoAdjuntoFirmante_Historico_2022 tt
...
-- cross apply Tramite.ExpedienteDocumentoAdjunto_Historico_2022 tt
-- where t.IdExpedienteDocumentoAdjunto = tt.IdExpedienteDocumentoAdjunto


-- delete t from Tramite.ExpedienteDocumentoFirmante t
-- cross apply Tramite.ExpedienteDocumentoFirmante_Historico_2022 tt
