...
-- cross apply Tramite.NumeracionSeparada_Historico_2023 tt
-- where tt.IdNumeracionSeparada = t.IdNumeracionSeparada


-- delete t from Tramite.ExpedienteDocumentoOrigenDestinoTemporal t
-- cross apply Tramite.ExpedienteDocumentoOrigenDestinoTemporal_Historico_2023 tt
...
-- cross apply Tramite.ExpedienteDocumentoOrigenDestinoAccion_Historico_2023 tt
...
-- cross apply Tramite.ExpedienteDocumentoOrigenDestino_Historico_2023 tt
...
-- cross apply Tramite.ExpedienteDocumentoOrigenAdjunto_Historico_2023 tt
...
-- cross apply Tramite.ExpedienteDocumentoOrigen_Historico_2023 tt
...
-- cross apply Tramite.ExpedienteDocumentoAdjuntoTemporal_Historico_2023 tt
...
-- cross apply Tramite.ExpedienteDocumentoAdjuntoFirmante_Historico_2023 tt
