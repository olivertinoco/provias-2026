...
BEGIN
    SET NOCOUNT ON;
    SET LANGUAGE 'SPANISH';          -- se conserva EXACTO el comportamiento de fechas del original
    ...
    BEGIN TRY
        ...
        /*======================================================================================
          [0] TODOS LOS TEMPORALES SE CREAN AQUI, CON SU INDICE INLINE, ANTES DE CUALQUIER DML.
              Esto evita las recompilaciones que v1 provocaba por hacer CREATE INDEX suelto y
              crear #Pagina en medio del batch.
        ======================================================================================*/
        CREATE TABLE #vTablaExpediente
        (
            eNroOrden        INT      NOT NULL PRIMARY KEY CLUSTERED,   -- clave de paginacion (SEEK del BETWEEN)
        ...
        /*======================================================================================
          [1] PAGINACION  ->  AQUI ESTABA EL 90% DEL COSTO.
              Se reescribe para ARRANCAR POR EDOD (predicados selectivos del especialista) y
              subir por PK: EDOD -> EDO -> ED -> E. EstadoAuditoria como literal = 1.
        ======================================================================================*/
        ...
        BEGIN
            ...
            BEGIN
                INSERT INTO #vTablaExpediente(eNroOrden, IdExpediente, FechaMovimiento)
                SELECT ROW_NUMBER() OVER(ORDER BY SE.FechaMovimiento DESC),
                       SE.IdExpediente, SE.FechaMovimiento
                FROM
                (
        ...
        /*======================================================================================
          [2] MATERIALIZAR SOLO LA PAGINA (25-50 filas). El BETWEEN sobre eNroOrden es un SEEK
              gracias a la PK clustered inline de #vTablaExpediente.
        ======================================================================================*/
        ...
        /*======================================================================================
          [3] ENRIQUECIMIENTO DE DOCUMENTO (Numero + Id + Dias)  --  IDENTICO A v1 (validado).
              Camino caliente Destino (@pSit IN 4,5,112): una sola pasada set-based sobre la pagina.
        ======================================================================================*/
        ...
        BEGIN
            /*----------------------------------------------------------------------------------
              Ramas raras (@pSit IN 111,3,6,116 y otros): se reutilizan los escalares EXISTENTES,
              pero SOLO sobre la pagina (25-50 filas). Mismo resultado exacto -> regresion = 0.
            ----------------------------------------------------------------------------------*/
            UPDATE P
        ...
        /*======================================================================================
          [4] PROYECCION FINAL  --  IDENTICA A v1. Los 4 lookups triviales y la Foto se resuelven
              SOLO sobre la pagina. En SQL 2019+ los Scalar UDF entran a Froid (inlining).
        ======================================================================================*/
        SELECT
