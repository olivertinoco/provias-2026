...
-- 0,'13/04/2026','13/04/2026',0,'13/04/2026','13/04/2026',590,588,4,4,0,0,2026,0,0,0,'','','','',0,'','','',590,NULL,NULL,1,100,NULL,0
	 ...
	 begin
		...
		select*from @MITABLA
		select*from tramite.Expediente where NumeroExpediente = 26962
        order by IdPeriodo, IdSerieDocumentalExpediente
        return
