...
AS
	BEGIN TRY
		...
		SELECT Periodo,[Tipo Documento],Expediente,Anulado,NombreArea[Nombre Area],NombreCargo[Nombre Cargo],NombreCompleto[Nombre Completo],Documento, [Fecha documento],Asunto,Observaciones,Destinatario,Logueo FROM (
			SELECT
			DISTINCT
			--E.IdPeriodo Periodo,
