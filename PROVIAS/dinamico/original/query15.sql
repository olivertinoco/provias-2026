...
SET LANGUAGE SPANISH
	...
	BEGIN
		...
		WHERE E.EstadoAuditoria=1 )X WHERE 1=1 ' + @Filtros
		...
		' AND ED.IdCargoEmisor in(SELECT IdCargo FROM General.Cargo WHERE IdCatalogoTipoCargo in (32,33,34))
		...
		LEFT JOIN General.Persona PE ON PE.IdPersona=E.IdPersonaCreador
		LEFT JOIN Tramite.Catalogo CTT ON CTT.IdCatalogo=E.IdCatalogoTipoTramite
		WHERE E.EstadoAuditoria=1 )X WHERE 1=1 ' +@Filtros + @Orden + @Offset + @Fetch
	...
	BEGIN
		...
		LEFT JOIN General.Persona PE ON PE.IdPersona=E.IdPersonaCreador
		LEFT JOIN Tramite.Catalogo CTT ON CTT.IdCatalogo=E.IdCatalogoTipoTramite
		WHERE E.EstadoAuditoria=1 ) X  WHERE X.EsMiAnulado=X.ExpedienteAnulado ' + @Filtros
		...
		LEFT JOIN General.Persona PE ON PE.IdPersona=E.IdPersonaCreador
		LEFT JOIN Tramite.Catalogo CTT ON CTT.IdCatalogo=E.IdCatalogoTipoTramite
		WHERE E.EstadoAuditoria=1 ) X  WHERE X.EsMiAnulado=X.ExpedienteAnulado ' + @Filtros + @Orden + @Offset + @Fetch
