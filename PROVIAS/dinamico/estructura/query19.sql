...
BEGIN TRY
	...
	INNER JOIN Tramite.ExpedienteDocumentoOrigen EDO ON EDO.IdExpedienteDocumentoOrigen=EDOD.IdExpedienteDocumentoOrigen and EDO.EstadoAuditoria=1 AND EDO.IdPeriodo = @pIdPeriodo
	INNER JOIN Tramite.ExpedienteDocumento ED ON ED.IdExpedienteDocumento=EDO.IdExpedienteDocumento AND ED.EstadoAuditoria=1 AND ED.IdPeriodo = @pIdPeriodo
	...
	WHERE EDOD.IdExpedienteDocumentoOrigenDestino=@pIdExpedienteDocumentoOrigenDestino AND EDOD.EstadoAuditoria=1 AND EDOD.IdPeriodo = @pIdPeriodo
