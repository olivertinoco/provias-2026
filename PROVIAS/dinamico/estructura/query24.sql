ALTER PROCEDURE [Tramite].[paListarExpedienteAcervoDocumentalExportarExcelEspecialista]
    @pIdAreaEmisor INT,
    @pIdPersona INT,
...
set language spanish
	...
	SELECT Periodo,[Tipo Documento],Expediente,Anulado,NombreArea[Nombre Area],NombreCargo[Nombre Cargo],NombreCompleto[Nombre Completo],Documento, [Fecha documento],Asunto,Observaciones,Destinatario,Logueo
...
BEGIN CATCH
    ...
    @ERROR_PROCEDURE='Tramite.paListarExpedienteAcervoDocumentalExportarExcelEspecialista',@ERROR_LINE=ERROR_LINE(),@ERROR_MESSAGE=ERROR_MESSAGE()
