...
SET LANGUAGE SPANISH
	...
	WHERE EDOD.EstadoAuditoria=1 AND E.IdExpediente=@pIdExpediente and E.EstadoAuditoria=1 AND E.IdPeriodo = @pIdPeriodo
...
BEGIN CATCH
    ...
    @ERROR_PROCEDURE='Tramite.paListarDocumentoHojaRutaV1',@ERROR_LINE=ERROR_LINE(),@ERROR_MESSAGE=ERROR_MESSAGE()
