...
SET LANGUAGE SPANISH;
    ...
    WHERE E.IdPeriodo = @pIdPeriodo AND EDOD.EstadoAuditoria=1 AND EDOD.IdCatalogoTipoMovimientoDestino=72 AND E.IdExpediente='+CONVERT(NVARCHAR,@pIdExpediente) +' AND EDO.IdAreaOrigenEnvia='+CONVERT(VARCHAR,@pIdArea)
    +@Filtros + @vCondicionVerSoloMio
