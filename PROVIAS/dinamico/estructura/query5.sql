...
BEGIN TRY
	...
	INNER JOIN Tramite.ExpedienteDocumentoOrigenDestino EDOD ON EDOD.IdExpedienteDocumentoOrigen=EDO.IdExpedienteDocumentoOrigen and EDO.EstadoAuditoria=1 and EDOd.EstadoAuditoria=1 AND EDOD.IdPeriodo = @pIdPeriodo
	...
	WHERE E.IdExpediente='+LTRIM(@pIdExpediente)+' AND EDOD.IdExpedienteDocumentoOrigenDestinoAnterior=0 AND EDOD.IdExpedienteDocumentoOrigenAnterior=0 AND E.EstadoAuditoria=1 AND ED.EstadoAuditoria=1 AND E.IdPeriodo = @pIdPeriodo'
	+@Filtros
...
BEGIN CATCH
	...
	@ERROR_PROCEDURE='Tramite.paListarExpedienteDocumentoHojaRuta',@ERROR_LINE=ERROR_LINE(),@ERROR_MESSAGE=ERROR_MESSAGE()
