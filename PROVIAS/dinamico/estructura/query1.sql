...
BEGIN TRY
	...
	WHERE E.IdPeriodo = @pIdPeriodo and
...
BEGIN CATCH
	...
	@ERROR_PROCEDURE='Tramite.paListarExpedientePendienteEspecialistaTodos',@ERROR_LINE=ERROR_LINE(),@ERROR_MESSAGE=ERROR_MESSAGE()
