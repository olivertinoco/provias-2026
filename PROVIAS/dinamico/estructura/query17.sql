ALTER PROCEDURE [Tramite].[paObtenerExpedienteDocumento]
...
SET LANGUAGE SPANISH
    ...
    INNER join Tramite.Expediente EX on EX.IdExpediente=E.IdExpediente AND EX.IdPeriodo = @pIdPeriodo
    LEFT join Tramite.Expediente EXV on EXV.IdExpediente=E.IdExpedienteVirtual AND EXV.IdPeriodo = @pIdPeriodo
    ...
    WHERE E.IdExpedienteDocumento=@pIdExpedienteDocumento AND E.EstadoAuditoria=1 AND E.IdPeriodo = @pIdPeriodo
...
BEGIN CATCH
	...
	@ERROR_PROCEDURE='Tramite.paObtenerExpedienteDocumento',@ERROR_LINE=ERROR_LINE(),@ERROR_MESSAGE=ERROR_MESSAGE()
